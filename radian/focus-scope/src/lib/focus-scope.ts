...
export const RadianFocusScopeContext =
  new InjectionToken<RadianFocusScopeContext>('[Radian] Focus Scope Context');
...
export class RadianFocusScope {
  ...
  private context = inject(RadianFocusScopeContext);
      ...
      effect((onCleanup) => {
        ...
        onCleanup(() => {
          ...
          if (!unmountEvent.defaultPrevented) {
            this.focus(previouslyFocusedElement ?? document.body, {
              select: true,
            });
          }
