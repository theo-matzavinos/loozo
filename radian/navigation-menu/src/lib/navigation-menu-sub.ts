...
type InjectionTokenType<T> = T extends InjectionToken<infer U> ? U : never;
...
export class RadianNavigationMenuSub {
  ...
  private static contextFactory(): InjectionTokenType<
    typeof RadianNavigationMenuContext
  > {
    ...
    return {
      ...
      viewportOutlet: context.viewportOutlet,
