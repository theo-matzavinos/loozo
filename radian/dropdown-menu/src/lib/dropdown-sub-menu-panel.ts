...
import { RadianSubMenuPanel } from '@loozo/radian/menu';
import { RadianPopperSide, RadianPopperAlignment } from '@loozo/radian/popper';

@Directive({
  selector: '[radianDropdownSubMenuPanel]',
  hostDirectives: [
    {
      directive: RadianSubMenuPanel,
      inputs: [
        'sideOffset',
        'align',
        'alignOffset',
...
export class RadianDropdownSubMenuPanel {
  /**
  ...
  private menuPanel = inject(RadianSubMenuPanel);
