...
export type RadianHoverCardContext = ReturnType<
  (typeof RadianHoverCard)['contextFactory']
>;
...
export class RadianHoverCard {
  ...
  private static contextFactory() {
    ...
    return {
      ...
      hasSelection: hoverCard.hasSelection.asReadonly(),
      isPointerDownOnContent: hoverCard.isPointerDownOnContent.asReadonly(),
    };
  }
}
